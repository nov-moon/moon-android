...
#保留annotation注解的类和类成员
-keepclassmembers @com.meili.sdk.http.annotation.* class * {*;}

#保留OnClick注解的方法
-keepclassmembers class * {
    @com.meili.sdk.view.annotation.OnClick <methods>;
}

#保留网络请求的builder和parser
-keep class * extends com.meili.sdk.http.common.IParamsBuilder {*;}
-keep class * extends com.meili.sdk.http.common.IResponseParser {*;}

#保留tasks
-keep class * extends com.meili.sdk.task.AbsTask {*;}
...
-keep class * extends com.meili.component.uploadimg.MLUploadModel {*;}

#保留BaseModel的子类及成员
-keep class * extends com.meili.sdk.app.base.http.BaseModel {*;}
