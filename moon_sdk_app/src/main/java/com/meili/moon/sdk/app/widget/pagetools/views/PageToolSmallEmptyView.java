 ...
 */
public class PageToolSmallEmptyView implements PageToolView {
    ...
    public View onCreateView(Context context, ViewGroup parent) {
        ...
        this.view = LayoutInflater.from(context).inflate(R.layout.moon_sdk_app_page_tool_small_empty_large, parent, false);
