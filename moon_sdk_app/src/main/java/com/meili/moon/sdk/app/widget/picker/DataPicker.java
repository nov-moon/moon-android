...
public class DataPicker extends View {
    ...
    public DataPicker setStartNumber(int startNumber) {
    ...
    public DataPicker setEndNumber(int endNumber) {
    ...
    public DataPicker setCurrentNumber(int currentNumber) {
    ...
    public DataPicker setRowNumber(int rowNumber) {
    ...
    public DataPicker setTextColor(int color) {
        mTextColor = color;
        initPaint();
        invalidate();
        return this;
    ...
    public DataPicker setFlagTextColor(int color) {
    ...
    public DataPicker setTextSize(float textSize) {
        mTextSize = textSize;
        init();
        invalidate();
        return this;
    ...
    public DataPicker setFlagTextSize(float textSize) {
    ...
    public DataPicker setBackground(int color) {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(DataPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(DataPicker picker, int scrollState);
    }

    public DataPicker setOnScrollListener(OnScrollListener l) {
        mOnScrollListener = l;
        return this;
    }

    public DataPicker setOnValueChangeListener(OnValueChangeListener l) {
    ...
    public DataPicker setSoundEffect(Sound sound) {
        mSound = sound;
        return this;
    }
     ...
     * @param textArray
     */
    public DataPicker setCustomTextArray(String[] textArray) {
